...
def rnn_step_forward(x, prev_h, Wx, Wh, b):
    ...
    cache = (temp,next_h, x, prev_h, Wx, Wh)
...
def rnn_step_backward(dnext_h, cache):
    ...
    ##############################################################################
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    temp,next_h, x, prev_h, Wx, Wh = cache
...
def lstm_step_forward(x, prev_h, prev_c, Wx, Wh, b):
    ...
    cache = (x, prev_h, prev_c, Wx, Wh, ai, af,ao, ag ,next_c, next_h)
...
def lstm_step_backward(dnext_h, dnext_c, cache):
    ...
    x, prev_h, prev_c, Wx, Wh, ai, af, ao, ag ,next_c, next_h = cache

    
        
    dao = dnext_h * np.tanh(next_c)
    dnext_c1 = dnext_h * (1 - (np.tanh(next_c))**2) * ao
    dnext_c += dnext_c1
    dprev_c = dnext_c * af
    daf = dnext_c * prev_c
    dai = dnext_c* ag
    ...
    dy = np.concatenate((dy1, dy2, dy3, dy4),axis=1)
    dprev_h = dy.dot(Wh.T)
    dWh = prev_h.T.dot(dy)
    dx = dy.dot(Wx.T)
    dWx = x.T.dot(dy)
